...
const LiveSearchSelect = (props) => {
    ...
    const context = (0, react_2.useContext)(adou_form_1.FormContext);
    const [value, setValue] = (0, react_2.useState)(""); // 给个 || ""就会让 input为受控状态，不能让它默认是 defaultValue，有可能不存在。。
    ...
    return react_1.default.createElement("div", { className: cls },
        react_1.default.createElement("input", { value: value, onChange: (e) => handleInputChange(e), onClick: handleInputClick, ref: inputRef, disabled: disabled, type: "text", className: "form-control", "aria-label": "Username", "aria-describedby": "basic-addon1" }),
