...
const Select = (props) => {
    ...
    return react_2.default.createElement(react_2.default.Fragment, null,
        react_2.default.createElement("select", { style: { flex: 1 }, value: value?.value, onChange: (e) => handleSelect(e), className: cls, "aria-label": ".form-select-lg example", disabled: disabled }, options.map(item => react_2.default.createElement("option", { disabled: item.disabled, key: item.value, value: item.value }, item.label))));
};
