...
.cascader-wrapper .label-box {
  font-size: 14px;
  min-width: 50px;
}
.cascader-wrapper .content {
  flex: 1;
}
.cascader-wrapper .content .cascader-content {
  position: relative;
...
.cascader-wrapper .content .cascader-content.focus, .cascader-wrapper .content .cascader-content:focus {
  border-color: #80bdff;
  outline: 0;
  box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, 0.25);
}
.cascader-wrapper .content .cascader-content .left {
  flex: 1;
  display: flex;
}
.cascader-wrapper .content .cascader-content .left .select-data-box {
  display: flex;
}
.cascader-wrapper .content .cascader-content .left .select-data-box .select-data {
  display: flex;
  align-items: center;
}
.cascader-wrapper .content .cascader-content .left .select-data-box .select-data .separator {
  color: #a5a5a5;
  font-size: 10px;
  margin: 0 15px;
}
.cascader-wrapper .content .cascader-content .left .input-box {
  flex: 1;
}
.cascader-wrapper .content .cascader-content .left .input-box .input {
  width: 100%;
  border: none;
}
.cascader-wrapper .content .cascader-content .left .input-box .input:focus {
  outline: none;
}
.cascader-wrapper .content .cascader-content .right .clear-icon {
  width: 16px;
}
.cascader-wrapper .content .cascader-content .right .opt-icon {
  position: absolute;
  top: 10px;
  right: 14px;
  transition: transform 0.2s;
}
.cascader-wrapper .content .cascader-content .right .opt-icon.focus {
  transform: rotate(90deg);
}
.cascader-wrapper .content .cascader-content .right .opt-icon:hover {
  transform: scale(1.4);
}
...
.cascader-option-box .cascader-option-content {
  display: flex;
  position: relative;
  /* 自定义滚动条样式 */
}
.cascader-option-box .cascader-option-content .cascader-option {
  position: relative;
  display: flex;
  align-items: center;
  justify-content: space-between;
...
.cascader-option-box .cascader-option-content .cascader-option:hover {
  background-color: #f5f7fa;
  cursor: pointer;
}
.cascader-option-box .cascader-option-content .cascader-option-active {
  color: #409eff;
  font-weight: bold;
}
.cascader-option-box .cascader-option-content .data1-box {
  min-width: 200px;
  padding: 8px 0;
...
.cascader-option-box .cascader-option-content .data3-box,
.cascader-option-box .cascader-option-content .data2-box {
  min-width: 200px;
  padding: 8px 0;
  height: 204px;
  overflow: auto;
...
.cascader-option-box .cascader-option-content .data3-box-open,
.cascader-option-box .cascader-option-content .data2-box-open {
  min-width: 200px;
  opacity: 1;
  border-right: 1px solid #e4e7ed;
}
.cascader-option-box .cascader-option-content .data3-box:hover,
.cascader-option-box .cascader-option-content .data2-box:hover {
  overflow: auto;
}
.cascader-option-box .cascader-option-content .data1-box::-webkit-scrollbar,
.cascader-option-box .cascader-option-content .data2-box::-webkit-scrollbar,
.cascader-option-box .cascader-option-content .data3-box::-webkit-scrollbar {
  /* 滚动条宽度 */
  width: 6px;
  border-radius: 10px;
}
.cascader-option-box .cascader-option-content .data1-box::-webkit-scrollbar-thumb,
.cascader-option-box .cascader-option-content .data2-box::-webkit-scrollbar-thumb,
.cascader-option-box .cascader-option-content .data3-box::-webkit-scrollbar-thumb {
  background: #d6d8dd;
  /* 滚动条颜色 */
  border-radius: 10px;
  /* 圆角 */
...
.cascader-option-box .cascader-option-content .data1-box::-webkit-scrollbar-track,
.cascader-option-box .cascader-option-content .data2-box::-webkit-scrollbar-track,
.cascader-option-box .cascader-option-content .data3-box::-webkit-scrollbar-track {
  /* 滚动条轨道颜色 */
  border-radius: 10px;
  /* 圆角 */
}
.cascader-option-box .arrow {
  position: absolute;
  width: 0;
  height: 0;
  border-style: solid;
...
.cascader-option-box-open {
  ...
  overflow-y: auto;
  overflow: visible !important;
}`, "",{"version":3,"sources":["webpack://./src/index.scss"],"names":[],"mappings":"AAAA,gBAAgB;AAEZ;EACI,eAAA;EACA,eAAA;AAAR;AAGI;EACI,OAAA;AADR;AAGQ;EACI,kBAAA;EACA,yBAAA;EACA,sBAAA;EACA,yBAAA;EACA,eAAA;EACA,wEAAA;EACA,aAAA;EACA,mBAAA;EACA,8BAAA;EACA,sBAAA;AADZ;AAGY;EAEI,qBAAA;EACA,UAAA;EACA,gDAAA;AAFhB;AAMY;EACI,OAAA;EACA,aAAA;AAJhB;AAMgB;EACI,aAAA;AAJpB;AAMoB;EACI,aAAA;EACA,mBAAA;AAJxB;AAMwB;EACI,cAAA;EACA,eAAA;EACA,cAAA;AAJ5B;AASgB;EACI,OAAA;AAPpB;AASoB;EACI,WAAA;EACA,YAAA;AAPxB;AASwB;EACI,aAAA;AAP5B;AAcgB;EACI,WAAA;AAZpB;AAegB;EAOI,kBAAA;EACA,SAAA;EACA,WAAA;EACA,0BAAA;AAnBpB;AAYoB;EACI,wBAAA;AAVxB;AAkBoB;EACI,qBAAA;AAhBxB;;AAwBA;EACI,aAAA;EACA,mBAAA;EACA,uBAAA;AArBJ;;AAwBA;EACI,aAAA;EACA,sBAAA;AArBJ;;AAwBA;EACI,aAAA;AArBJ;AAuBI;EACI,aAAA;EACA,kBAAA;AArBR;;AA0BA;EACI,gBAAA;EACA,qBAAA;EACA,sBAAA;EACA,4BAAA;EACA,WAAA;EACA,kBAAA;EACA,iBAAA;EACA,kBAAA;EACA,4CAAA;EACA,wEAAA;EACA,UAAA;EACA,kBAAA;EACA,oBAAA;EACA,qBAAA;AAvBJ;AAyBI;EACI,aAAA;EACA,kBAAA;EAuDA,aAAA;AA7ER;AAwBQ;EACI,kBAAA;EACA,aAAA;EACA,mBAAA;EACA,8BAAA;EACA,sBAAA;EACA,YAAA;EACA,iBAAA;EACA,aAAA;AAtBZ;AAwBY;EACI,yBAAA;EACA,eAAA;AAtBhB;AAyBY;EACI,cAAA;EACA,iBAAA;AAvBhB;AA2BQ;EACI,gBAAA;EACA,cAAA;EACA,+BAAA;EACA,aAAA;EACA,cAAA;AAzBZ;AA6BQ;;EAEI,gBAAA;EACA,cAAA;EACA,aAAA;EAEA,cAAA;EACA,yBAAA;EACA,UAAA;EACA,mBAAA;EAQA,eAAA;AAnCZ;AA6BY;;EACI,gBAAA;EACA,UAAA;EACA,+BAAA;AA1BhB;AA8BY;;EACI,cAAA;AA3BhB;AAgCQ;;;EAGI,UAAA;EACA,UAAA;EACA,mBAAA;AA9BZ;AAiCQ;;;EAGI,mBAAA;EACA,UAAA;EACA,mBAAA;EACA,OAAA;EACA,gBAAA;EACA,WAAA;AA/BZ;AAkCQ;;;EAGI,YAAA;EACA,mBAAA;EACA,OAAA;AAhCZ;AAoCI;EACI,kBAAA;EACA,QAAA;EACA,SAAA;EACA,mBAAA;EAEA,gBAAA;EACA,2BAAA;EACA,mBAAA;EACA,sDAAA;EACA,SAAA;EACA,SAAA;EACA,2BAAA;AAnCR;;AAuCA;EACI,aAAA;EACA,kBAAA;EACA,cAAA;AApCJ;;AAuCA;EACI,UAAA;EACA,mBAAA;EACA,oBAAA;EACA,gBAAA;EACA,4BAAA;AApCJ","sourcesContent":[".cascader-wrapper {\r\n\r\n    .label-box {\r\n        font-size: 14px;\r\n        min-width: 50px\r\n    }\r\n\r\n    .content {\r\n        flex: 1;\r\n\r\n        .cascader-content {\r\n            position: relative;\r\n            border: 1px solid #ced4da;\r\n            border-radius: 0.25rem;\r\n            padding: 0.375rem 0.75rem;\r\n            cursor: pointer;\r\n            transition: border-color 0.15s ease-in-out, box-shadow 0.15s ease-in-out;\r\n            display: flex;\r\n            align-items: center;\r\n            justify-content: space-between;\r\n            box-sizing: border-box;\r\n\r\n            &.focus,\r\n            &:focus {\r\n                border-color: #80bdff;\r\n                outline: 0;\r\n                box-shadow: 0 0 0 0.2rem rgba(0, 123, 255, 0.25);\r\n            }\r\n\r\n\r\n            .left {\r\n                flex: 1;\r\n                display: flex;\r\n\r\n                .select-data-box {\r\n                    display: flex;\r\n\r\n                    .select-data {\r\n                        display: flex;\r\n                        align-items: center;\r\n\r\n                        .separator {\r\n                            color: #a5a5a5;\r\n                            font-size: 10px;\r\n                            margin: 0 15px;\r\n                        }\r\n                    }\r\n                }\r\n\r\n                .input-box {\r\n                    flex: 1;\r\n\r\n                    .input {\r\n                        width: 100%;\r\n                        border: none;\r\n\r\n                        &:focus {\r\n                            outline: none;\r\n                        }\r\n                    }\r\n                }\r\n            }\r\n\r\n            .right {\r\n                .clear-icon {\r\n                    width: 16px;\r\n                }\r\n\r\n                .opt-icon {\r\n                    // width: 16px;\r\n\r\n                    &.focus {\r\n                        transform: rotate(90deg);\r\n                    }\r\n\r\n                    position: absolute;\r\n                    top: 10px;\r\n                    right: 14px;\r\n                    transition: transform 0.2s;\r\n\r\n                    &:hover {\r\n                        transform: scale(1.4);\r\n                    }\r\n                }\r\n            }\r\n        }\r\n    }\r\n}\r\n\r\n.label-in-center {\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n}\r\n\r\n.label-in-top {\r\n    display: flex;\r\n    flex-direction: column;\r\n}\r\n\r\n.label-in-left-top {\r\n    display: flex;\r\n\r\n    .label-box {\r\n        display: flex;\r\n        align-items: start;\r\n    }\r\n}\r\n\r\n\r\n.cascader-option-box {\r\n    min-width: 200px;\r\n    text-align-last: left;\r\n    background-color: #fff;\r\n    overflow: visible !important; // 为了展示小角标\r\n    /* 隐藏溢出内容 */\r\n    position: absolute;\r\n    z-index: 66666666;\r\n    border-radius: 4px;\r\n    box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;\r\n    transition: opacity 0.3s ease, visibility 0.3s ease, transform 0.3s ease;\r\n    opacity: 0;\r\n    visibility: hidden;\r\n    transform: scaleY(0);\r\n    transform-origin: top;\r\n\r\n    .cascader-option-content {\r\n        display: flex;\r\n        position: relative;\r\n\r\n        .cascader-option {\r\n            position: relative;\r\n            display: flex;\r\n            align-items: center;\r\n            justify-content: space-between;\r\n            padding: 0 15px 0 20px;\r\n            height: 34px;\r\n            line-height: 34px;\r\n            outline: none;\r\n\r\n            &:hover {\r\n                background-color: #f5f7fa;\r\n                cursor: pointer;\r\n            }\r\n\r\n            &-active {\r\n                color: #409eff;\r\n                font-weight: bold;\r\n            }\r\n        }\r\n\r\n        .data1-box {\r\n            min-width: 200px;\r\n            padding: 8px 0;\r\n            border-right: 1px solid #e4e7ed;\r\n            height: 204px;\r\n            overflow: auto;\r\n        }\r\n\r\n\r\n        .data3-box,\r\n        .data2-box {\r\n            min-width: 200px; // 必须使用 min-width，不然会出现样式问题！\r\n            padding: 8px 0;\r\n            height: 204px;\r\n            // overflow: hidden;  /* 隐藏滚动条 */\r\n            overflow: auto;\r\n            transition: all 0.5s ease;\r\n            opacity: 0;\r\n            white-space: nowrap;\r\n\r\n            &-open {\r\n                min-width: 200px;\r\n                opacity: 1;\r\n                border-right: 1px solid #e4e7ed;\r\n            }\r\n\r\n            /* 鼠标移入时显示滚动条 */\r\n            &:hover {\r\n                overflow: auto;\r\n            }\r\n        }\r\n\r\n        /* 自定义滚动条样式 */\r\n        .data1-box::-webkit-scrollbar,\r\n        .data2-box::-webkit-scrollbar,\r\n        .data3-box::-webkit-scrollbar {\r\n            /* 滚动条宽度 */\r\n            width: 6px;\r\n            border-radius: 10px;\r\n        }\r\n\r\n        .data1-box::-webkit-scrollbar-thumb,\r\n        .data2-box::-webkit-scrollbar-thumb,\r\n        .data3-box::-webkit-scrollbar-thumb {\r\n            background: #d6d8dd;\r\n            /* 滚动条颜色 */\r\n            border-radius: 10px;\r\n            /* 圆角 */\r\n            min-height: 30px;\r\n            /* 设置最小长度 */\r\n        }\r\n\r\n        .data1-box::-webkit-scrollbar-track,\r\n        .data2-box::-webkit-scrollbar-track,\r\n        .data3-box::-webkit-scrollbar-track {\r\n            /* 滚动条轨道颜色 */\r\n            border-radius: 10px;\r\n            /* 圆角 */\r\n        }\r\n    }\r\n\r\n    .arrow {\r\n        position: absolute;\r\n        width: 0;\r\n        height: 0;\r\n        border-style: solid;\r\n\r\n        /* 调整边框宽度以放大箭头 */\r\n        border-width: 0 8px 8px 8px;\r\n        /* 将这里的10px改为15px */\r\n        border-color: transparent transparent #fff transparent;\r\n        top: -7px;\r\n        left: 50%;\r\n        transform: translateX(-50%);\r\n    }\r\n}\r\n\r\n.none-match {\r\n    height: 100px;\r\n    font-style: italic;\r\n    color: #a4a3a3;\r\n}\r\n\r\n.cascader-option-box-open {\r\n    opacity: 1;\r\n    visibility: visible;\r\n    transform: scaleY(1);\r\n    overflow-y: auto;\r\n    overflow: visible !important; // 为了展示小角标\r\n}"],"sourceRoot":""}]);
// Exports
...
const Cascader = /*#__PURE__*/(0,external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef)((_ref, ref) => {
  let {
    width,
    inline,
    activeColor = {
  ...
  const [selectedValues, setSelectedValues] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)(defaultValue);
  const [isFocused, setIsFocused] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)(false);
  ...
  // 存储展示的数据
  const [data1, setData1] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)([]);
  const [data2, setData2] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)([]);
  const [data3, setData3] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)([]);

  // 为了显示动画
  const [showData2, setShowData2] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)(false);
  const [showData3, setShowData3] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)(false);

  // 记录选中的值
  const [firstSelectData, setfirstSelectData] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)({});
  const [secondSelectData, setSecondSelectData] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)({});
  const [thirdSelectData, setThirdSelectData] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)({});

  // 是否可清除
  const [showClearIcon, setShowClearIcon] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)(false);
  const [error, setError] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)(false);
  const cascaderWrapperRef = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useRef)(null);
  const optionRef = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useRef)(null);
  ...
  const handleChange = (e, type, item) => {
    var _item$children;
    ...
    switch (type) {
      ...
      case 3:
        ...
        if (returnType === "obj") {
          onFormDataChange && onFormDataChange(name, [firstSelectData, secondSelectData, item]);
        } else {
          onFormDataChange && onFormDataChange(name, [firstSelectData[valueKey], secondSelectData[valueKey], item[valueKey]]);
        }
        setTimeout(() => {
          setError(false);
        }, 10);
  ...
  const handleWrapperClick = () => {
    ...
    setIsShow(true);
    setIsOpen(true);
    const position = (0,Utils.getAbsolutePosition)(cascaderWrapperRef.current, 0, 0);
  ...
  const convertData2 = options => {
    setData2(options.children || []);
  };
  const convertData3 = options => {
    setData3(options.children || []);
  };
  const convertData1 = options => {
    options.forEach(item => {
      setData1(preData => [...preData, item]);
    });
  };
  const handleClose = () => {
    setIsOpen(false);
  ...
  const validate = () => {
    ...
    if (thirdSelectData !== null && thirdSelectData !== void 0 && thirdSelectData[valueKey]) {
      setError(false);
      return true;
    } else {
      setError(true);
  ...
  (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useEffect)(() => {
    if (defaultValue !== null && defaultValue !== void 0 && defaultValue.length) {
      ...
      defaultValue.forEach((item, index) => {
        var _firstItem, _secondItem;
        switch (index) {
          case 0:
            firstItem = data1.find(dataItem => dataItem[valueKey] === item);
            if (firstItem) {
          ...
          case 1:
            ...
            secondItem = (_firstItem = firstItem) === null || _firstItem === void 0 ? void 0 : _firstItem.children.find(dataItem => dataItem[valueKey] === item);
            if (secondItem) {
          ...
          case 2:
            ...
            thirdItem = (_secondItem = secondItem) === null || _secondItem === void 0 ? void 0 : _secondItem.children.find(dataItem => dataItem[valueKey] === item);
            if (thirdItem) {
  ...
  src_useClickOutside([cascaderWrapperRef, optionRef], handleClose, cascaderWrapperRef.current && isFocused);
  return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "cascader-wrapper ".concat(isFormItem ? "mb-3" : ""),
    style: {
      ...(inline ? {
        marginRight: "15px"
      } : ""),
    ...
    className: "left  label-in-".concat(labelPosition)
  }, String(isFocused), "111", showLabel && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "label-box",
    style: {
      width: labelWidth,
      color: labelColor
    ...
    className: "cascader-content rounded ".concat(isFocused ? "focus" : ""),
    tabIndex: 0
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "left"
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "select-data-box"
  }, (firstSelectData === null || firstSelectData === void 0 ? void 0 : firstSelectData[valueKey]) && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "fist-select-data select-data"
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "text"
  }, firstSelectData === null || firstSelectData === void 0 ? void 0 : firstSelectData[labelKey]), (secondSelectData === null || secondSelectData === void 0 ? void 0 : secondSelectData[valueKey]) && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "separator"
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("i", {
    className: "fa-solid fa-angles-right"
  }))), (secondSelectData === null || secondSelectData === void 0 ? void 0 : secondSelectData[valueKey]) && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "second-select-data select-data"
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "text"
  }, secondSelectData === null || secondSelectData === void 0 ? void 0 : secondSelectData[labelKey]), (thirdSelectData === null || thirdSelectData === void 0 ? void 0 : thirdSelectData[valueKey]) && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "separator"
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("i", {
    className: "fa-solid fa-angles-right"
  }))), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "third-select-data select-data"
  }, thirdSelectData === null || thirdSelectData === void 0 ? void 0 : thirdSelectData[labelKey])), filterable && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "input-box"
    ...
    className: "opt-box"
  }, showClearIcon ? /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("i", {
    onClick: handleClear,
    className: "clear-icon fa-regular fa-circle-xmark"
  }) : /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("i", {
    className: "opt-icon fa-solid fa-chevron-right ".concat(isFocused ? "focus" : "")
    ...
    style: {
      position: "absolute",
      top: customSelectContentPosition.y + customSelectContentPosition.height + 15 + "px",
      left: customSelectContentPosition.x + "px",
      ...(isShow ? {
        /* maxHeight: calcMaxHeight > parseInt(maxHeight!) ? maxHeight : calcMaxHeight + 'px', */
      } : {})
    },
    className: "cascader-option-box ".concat(isOpen ? "cascader-option-box-open" : "")
  }, isShow && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    ref: optionRef,
    className: "cascader-option-content"
  }, data1.length > 0 ? /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "data1-box"
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    ...
    return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
      key: index,
      className: "cascader-option ".concat(firstSelectData[valueKey] === item[valueKey] ? "cascader-option-active" : ""),
      onClick: e => handleChange(e, 1, item),
      style: {
        color: (firstSelectData === null || firstSelectData === void 0 ? void 0 : firstSelectData[valueKey]) === item[valueKey] ? activeColor.font : "#000",
        backgroundColor: (firstSelectData === null || firstSelectData === void 0 ? void 0 : firstSelectData[valueKey]) === item[valueKey] ? activeColor.bgc : ""
      }
    }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
      className: "text"
    }, item[labelKey]), ((_item$children2 = item.children) === null || _item$children2 === void 0 ? void 0 : _item$children2.length) > 0 && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
      className: "more-icon"
    }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("i", {
  ...
  }, "No content"), data2.length > 0 ? /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "data2-box ".concat(showData2 ? "data2-box-open" : "")
  }, data2.map((item, index) => {
    var _item$children3;
    return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
      key: index,
      className: "cascader-option ".concat(secondSelectData[valueKey] === item[valueKey] ? "cascader-option-active" : ""),
      onClick: e => handleChange(e, 2, item),
      style: {
        color: (secondSelectData === null || secondSelectData === void 0 ? void 0 : secondSelectData[valueKey]) === item[valueKey] ? activeColor.font : "#000",
        backgroundColor: (secondSelectData === null || secondSelectData === void 0 ? void 0 : secondSelectData[valueKey]) === item[valueKey] ? activeColor.bgc : ""
      }
    }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
      className: "text"
    }, item[labelKey]), ((_item$children3 = item.children) === null || _item$children3 === void 0 ? void 0 : _item$children3.length) > 0 && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
      className: "more-icon"
    }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("i", {
      className: "fa-solid fa-chevron-right"
    })));
  })) : "", data3.length > 0 ? /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "data3-box ".concat(showData3 ? "data3-box-open" : "")
  }, data3.map((item, index) => /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    key: index,
    className: "cascader-option ".concat(thirdSelectData[valueKey] === item[valueKey] ? "cascader-option-active" : ""),
    onClick: e => handleChange(e, 3, item),
    style: {
      color: (thirdSelectData === null || thirdSelectData === void 0 ? void 0 : thirdSelectData[valueKey]) === item[valueKey] ? activeColor.font : "#000",
      backgroundColor: (thirdSelectData === null || thirdSelectData === void 0 ? void 0 : thirdSelectData[valueKey]) === item[valueKey] ? activeColor.bgc : ""
    }
  }, item[labelKey]))) : ""), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "arrow"
  })), document.body)))), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "right"
...
/* harmony default export */ const src_0 = (Cascader);
})();
