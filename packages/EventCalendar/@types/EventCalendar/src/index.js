...
const src_2 = __importDefault(require("../../Modal/src"));
const src_3 = __importDefault(require("../../NewForm/src"));
const Input_1 = __importDefault(require("../../Input"));
const EventCalendar = ({ date, wrapperHeight, contentHeight, data = [], modalContent, renderEvent, }) => {
    /**
     * 点击某天高亮的逻辑
     */
     ...
     * 双击展示弹窗逻辑
     */
    const [dayInfo, setDayInfo] = (0, react_1.useState)();
    ...
    const getShouldShowPreMonthDays = () => {
        if (!currentMonthFirstDay && currentMonthFirstDay !== 0)
            return [];
    ...
    const getCurrentMonthDays = () => {
        if (!currentMonthLastDate || !currentMonthLastDate.getDate)
            return [];
     ...
     * 获取这个月的第一天和最后一天(date)
     */
    const [currentMonthFirstAndLastDate, setCurrentMonthFirstAndLastDate] = (0, react_1.useState)({});
    // 这个月的第一天(date)
    ...
    (0, react_1.useEffect)(() => {
        if (!currentMonthFirstDate || !currentMonthFirstDate.getDay)
            return;
    ...
    (0, react_1.useEffect)(() => { }, [finalShowData]);
    (0, react_1.useEffect)(() => {
        if (date) {
            setCurrentDate(date);
        }
    ...
    (0, react_1.useEffect)(() => { }, []);
    return (react_1.default.createElement("div", { className: "calendar-container", ref: calendarContainerRef, style: { height: wrapperHeight } },
        ...
        react_1.default.createElement("div", { className: "calendar-content mt-2", style: { height: calendarTableMaxHeight } },
            react_1.default.createElement("table", { className: "calendar-table", style: { height: "100%" } },
                ...
                react_1.default.createElement("tbody", null, finalShowData.map((week, weekIndex) => (react_1.default.createElement("tr", { key: weekIndex }, week.map((dayInfo, dayIndex) => (react_1.default.createElement("td", { onDoubleClick: () => handleTdDoubleClick(dayInfo), onClick: () => handleTdClick(dayInfo), key: dayInfo.id, className: `calendar-cell` },
                    react_1.default.createElement("div", { className: `calendar-cell-content-box` },
                        ...
                        react_1.default.createElement("div", { className: "calendar-cell-content-event" }, renderEvent ? renderEvent(dayInfo) : dayInfo.event))))))))))),
        ...
        react_1.default.createElement(src_2.default, { show: modalShow, onCancel: handleCloseModal, onClose: handleCloseModal, onConfirm: handleCofirmModal }, react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(src_3.default, { ref: formRef }, modalContent || (react_1.default.createElement(Input_1.default, { label: "\u4E8B\u4EF6", name: "event" })))))));
};
