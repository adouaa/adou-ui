...
import AdouModal from "../../Modal/src";
import AdouNewForm from "../../NewForm/src";
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ height: calendarTableMaxHeight }}
      >
      ...
      >
        {
          <>
            <AdouNewForm ref={formRef}>
              {modalContent || (
                <AdouInput label="事件" name="event"></AdouInput>
              )}
            </AdouNewForm>
          </>
        }
