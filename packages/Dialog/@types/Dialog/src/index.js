...
require("./index.scss");
const Dialog = ({ clickOutside = true, confirmText = "确定", cancelText = "取消", confirmBtnClass = "primary", cancelBtnClass = "secondary", show: isOpen = false, title = "提示", children = null, type = "", maxHeight = "500px", width = "600px", maxWidth, onCancel, onClose = () => { }, onConfirm = () => { }, }) => {
        ...
        react_dom_1.default.createPortal(react_1.default.createElement("div", { className: `dialog-overlay ${show ? "open" : ""}` },
            react_1.default.createElement("div", { ref: dialogRef, className: `dialog ${show ? "open" : ""}`, style: {
                ...
                react_1.default.createElement("div", { className: "dialog-footer d-flex justify-content-end p-3" },
                    ...
                    react_1.default.createElement(Button_1.default, { className: `btn-${confirmBtnClass}`, size: "md", onClickOK: onConfirm }, confirmText)))), document.body)));
};
