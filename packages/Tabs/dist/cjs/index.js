...
const Tabs = props => {
  ...
  const getCurrentLabel = () => {
    var _validChildren$curren;
    const childrenArr = external_root_React_commonjs2_react_commonjs_react_amd_react_default().Children.toArray(children);
    const validChildren = childrenArr.filter(Boolean);
    return (_validChildren$curren = validChildren[currentIndex]) === null || _validChildren$curren === void 0 || (_validChildren$curren = _validChildren$curren.props) === null || _validChildren$curren === void 0 ? void 0 : _validChildren$curren.label;
  };
