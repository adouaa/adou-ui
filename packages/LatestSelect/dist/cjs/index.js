...
.adou-select-wrapper .adou-select-form-content {
  height: 100%;
}
.adou-select-wrapper .adou-select-form-content.border-left-radius-none {
  border-top-left-radius: 0 !important;
  border-bottom-left-radius: 0 !important;
}
.adou-select-wrapper .adou-select-form-content .adou-select {
  height: 100%;
  border-radius: 0.475rem;
  transition: border-color 0.5s ease, box-shadow 0.5s ease;
  cursor: pointer;
}
.adou-select-wrapper .adou-select-form-content .adou-select i {
  transition: transform 0.3s ease;
  /* 添加过渡效果 */
}
.adou-select-wrapper .adou-select-form-content .adou-select-icon svg {
  transition: transform 0.2s;
}
.adou-select-wrapper .adou-select-form-content .adou-select-icon svg.rotate-down:hover {
  transform: scale(1.3) rotate(0deg);
}
.adou-select-wrapper .adou-select-form-content .adou-select-icon svg.rotate-up:hover {
  transform: scale(1.3) rotate(90deg);
}
.adou-select-wrapper .adou-select-form-content .adou-select-icon svg.rotate-up {
  transform: rotate(180deg) !important;
}
.adou-select-wrapper .adou-select-form-content .adou-select-clear-icon {
  cursor: pointer;
  transition: all 0.3s;
  color: #c6c6cd;
}
.adou-select-wrapper .adou-select-form-content .adou-select-clear-icon:hover {
  transform: scale(1.2);
  color: red !important;
}
.adou-select-wrapper .adou-select-form-content .adou-select-input {
  width: 100%;
  outline: none;
  border: none;
}
.adou-select-wrapper .adou-select-form-content .adou-select .adou-select-value-list-item-close svg {
  fill: red;
}
...
.adou-select-option-content-open {
  opacity: 1;
  visibility: visible;
  transform: scaleY(1);
}
.adou-select-option-content .adou-select-option {
  padding: 5px 10px;
}
.adou-select-option-content .adou-select-option:hover {
  background-color: var(--bs-tertiary-bg);
  cursor: pointer;
}
.adou-select-option-content .adou-select-option:active {
  color: #fff;
...
.adou-select-option-content .none-match {
  padding: 10px 0;
  height: 100px;
  font-style: italic;
  color: #a4a3a3;
...
.dark-mode .adou-select-wrapper .adou-select {
...
.ellipsis-1 {
  ...
  /* 使用省略号表示超出部分 */
}`, "",{"version":3,"sources":["webpack://./src/index.scss"],"names":[],"mappings":"AAAA,gBAAgB;AAEZ;EACI,YAAA;AAAR;AAEQ;EACI,oCAAA;EACA,uCAAA;AAAZ;AAIQ;EACI,YAAA;EACA,uBAAA;EAEA,wDAAA;EACA,eAAA;AAHZ;AAMY;EACI,+BAAA;EACA,WAAA;AAJhB;AAQgB;EACI,0BAAA;AANpB;AAQoB;EACI,kCAAA;AANxB;AASoB;EACI,mCAAA;AAPxB;AAUoB;EACI,oCAAA;AARxB;AAgBY;EAEI,eAAA;EACA,oBAAA;EACA,cAAA;AAfhB;AAiBgB;EACI,qBAAA;EACA,qBAAA;AAfpB;AAuBY;EAEI,WAAA;EACA,aAAA;EACA,YAAA;AAtBhB;AA0BgB;EACI,SAAA;AAxBpB;;AAoCA;EACI,qBAAA;EACA,gBAAA;EACA,WAAA;EACA,kBAAA;EACA,iBAAA;EACA,kBAAA;EACA,4CAAA;EACA,wEAAA;EACA,kBAAA;EACA,oBAAA;EACA,qBAAA;EACA,mCAAA;AAjCJ;AAmCI;EACI,UAAA;EACA,mBAAA;EACA,oBAAA;AAjCR;AAqCI;EACI,iBAAA;AAnCR;AAqCQ;EACI,uCAAA;EACA,eAAA;AAnCZ;AAsCQ;EACI,WAAA;EACA,mCAAA;AApCZ;AAwCI;EACI,iBAAA;EACA,8CAAA;EACA,sBAAA;AAtCR;AAyCI;EACI,UAAA;EACA,mBAAA;EACA,oBAAA;EACA,gBAAA;EACA,WAAA;AAvCR;AA0CI;EACI,eAAA;EACA,aAAA;EACA,kBAAA;EACA,cAAA;AAxCR;;AA6CI;EACI,qDAAA;AA1CR;;AA8CA;EACI,mBAAA;EACA,QAAA;EACA,gBAAA;EACA,WAAA;EACA,uBAAA;EACA,gBAAA;AA3CJ","sourcesContent":[".adou-select-wrapper {\r\n\r\n    .adou-select-form-content {\r\n        height: 100%;\r\n\r\n        &.border-left-radius-none {\r\n            border-top-left-radius: 0 !important;\r\n            border-bottom-left-radius: 0 !important;\r\n\r\n        }\r\n\r\n        .adou-select {\r\n            height: 100%;\r\n            border-radius: 0.475rem;\r\n            // box-shadow: 0 1px 1px rgba(0, 0, 0, 0.075); 加上这个在 borderless 情况下底部会有条线\r\n            transition: border-color 0.5s ease, box-shadow 0.5s ease;\r\n            cursor: pointer;\r\n            // padding: 0 12px;\r\n\r\n            i {\r\n                transition: transform 0.3s ease;\r\n                /* 添加过渡效果 */\r\n            }\r\n\r\n            &-icon {\r\n                svg {\r\n                    transition: transform 0.2s;\r\n\r\n                    &.rotate-down:hover {\r\n                        transform: scale(1.3) rotate(0deg);\r\n                    }\r\n\r\n                    &.rotate-up:hover {\r\n                        transform: scale(1.3) rotate(90deg);\r\n                    }\r\n\r\n                    &.rotate-up {\r\n                        transform: rotate(180deg) !important;\r\n                    }\r\n                }\r\n\r\n                .rotate-down {}\r\n            }\r\n\r\n\r\n            &-clear-icon {\r\n\r\n                cursor: pointer;\r\n                transition: all 0.3s;\r\n                color: #c6c6cd;\r\n\r\n                &:hover {\r\n                    transform: scale(1.2);\r\n                    color: red !important;\r\n                }\r\n            }\r\n\r\n            &-input-box {\r\n                // background-color: red;\r\n            }\r\n\r\n            &-input {\r\n                // min-width: 120px;\r\n                width: 100%;\r\n                outline: none;\r\n                border: none;\r\n            }\r\n\r\n            .adou-select-value-list-item-close {\r\n                svg {\r\n                    fill: red;\r\n                }\r\n            }\r\n        }\r\n    }\r\n\r\n\r\n\r\n\r\n\r\n}\r\n\r\n.adou-select-option-content {\r\n    text-align-last: left;\r\n    overflow: hidden;\r\n    /* 隐藏溢出内容 */\r\n    position: absolute;\r\n    z-index: 66666666;\r\n    border-radius: 4px;\r\n    box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;\r\n    transition: opacity 0.3s ease, visibility 0.3s ease, transform 0.3s ease;\r\n    visibility: hidden;\r\n    transform: scaleY(0);\r\n    transform-origin: top;\r\n    background-color: var(--bs-body-bg);\r\n\r\n    &-open {\r\n        opacity: 1;\r\n        visibility: visible;\r\n        transform: scaleY(1);\r\n    }\r\n\r\n\r\n    .adou-select-option {\r\n        padding: 5px 10px;\r\n\r\n        &:hover {\r\n            background-color: var(--bs-tertiary-bg);\r\n            cursor: pointer;\r\n        }\r\n\r\n        &:active {\r\n            color: #fff;\r\n            background-color: var(--bs-primary);\r\n        }\r\n    }\r\n\r\n    .adou-select-option-active {\r\n        font-weight: bold;\r\n        background-color: var(--bs-primary) !important;\r\n        color: #fff !important;\r\n    }\r\n\r\n    &-open {\r\n        opacity: 1;\r\n        visibility: visible;\r\n        transform: scaleY(1);\r\n        overflow-y: auto;\r\n        /* 允许垂直滚动 */\r\n    }\r\n\r\n    .none-match {\r\n        padding: 10px 0;\r\n        height: 100px;\r\n        font-style: italic;\r\n        color: #a4a3a3;\r\n    }\r\n}\r\n\r\n.dark-mode .adou-select-wrapper {\r\n    .adou-select {\r\n        border-color: var(--bs-dark-border-subtle) !important;\r\n    }\r\n}\r\n\r\n.ellipsis-1 {\r\n    white-space: nowrap;\r\n    /* 不换行 */\r\n    overflow: hidden;\r\n    /* 隐藏超出部分 */\r\n    text-overflow: ellipsis;\r\n    /* 使用省略号表示超出部分 */\r\n}"],"sourceRoot":""}]);
// Exports
...
const useThrottle = function (fn, delay) {
  let dependency = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  const time = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useRef)(0);
  const timer = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useRef)(null);
  // react中必须要用useCallback和useRef，不然状态改变就会一直变化
  return (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useCallback)(function () {
...
;// CONCATENATED MODULE: ./src/icon_close.tsx

const IconClose = /*#__PURE__*/(0,external_root_React_commonjs2_react_commonjs_react_amd_react_.memo)(props => {
  const [isHovered, setIsHovered] = external_root_React_commonjs2_react_commonjs_react_amd_react_default().useState(false);
  ...
  return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", null, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("svg", {
    style: {
      width: '18px',
      // 鼠标移入时放大宽度
      height: '18px',
...
const Select = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().forwardRef((props, ref) => {
  ...
  const [hasUseDefaultValue, sethasUseDefaultValue] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)(false);
  ...
  const [tempSelectValue, setTempSelectValue] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)(defaultValue || null);
  ...
  const handleClose = () => {
    ...
    if (mode === "common" && inputRef.current) {
      if (showSearch) {
        ...
        inputRef.current.value = (selectValue === null || selectValue === void 0 ? void 0 : selectValue[labelKey]) || "";
      } else {
  ...
  const getValue = () => {
    ...
    if (selectValue !== null && selectValue !== void 0 && selectValue[valueKey] || (selectValue === null || selectValue === void 0 ? void 0 : selectValue[valueKey]) === 0 || (selectValue === null || selectValue === void 0 ? void 0 : selectValue[valueKey]) === false) {
      // 感觉可有可无
      if (returnType === "obj") {
  ...
  const handleIconClick = e => {
    ...
    // 这边定时器的时间要给个比控制 isShow 定时器更晚的时间，不然会导致计算的时候，列表还没出现，高度为 0
    setTimeout(() => {
      calcContentPosition();
    }, 15);
  };
  const handleClearIconClick = e => {
    ...
    clear();
    setError(true);
    handleFieldChange === null || handleFieldChange === void 0 || handleFieldChange(multiple ? [] : returnType === "str" ? "" : {});
    handleValidate("");
  };
  ...
  const handleKeyDown = event => {
    if (event.key === "Tab") {
      ...
      if (event.key === "ArrowUp") {
        ...
        _focusedIndex = focusedIndex <= 0 ? newOptions.length - 1 : focusedIndex - 1;
      } else if (event.key === "ArrowDown") {
        event.preventDefault();
        _focusedIndex = focusedIndex >= newOptions.length - 1 ? 0 : focusedIndex + 1;
  ...
  const handleInputChange = e => {
    ...
    if (autoFillter) {
      ...
      const filteredOptions = originalOptions.filter(item => {
        return filterOption ? filterOption(value, item, labelKey, valueKey) : String(item[labelKey]).toLowerCase().includes(value.toLowerCase());
      });
      ...
      if (showDefaultValue || showSearch || mode === "liveSearch") {
        if (multiple) {
          ...
          if (typeof defaultValue !== "object") {
            ...
            let selectOption = options === null || options === void 0 ? void 0 : options.find(option => (option === null || option === void 0 ? void 0 : option[valueKey]) === defaultValue);
            if (!selectOption) {
              // 没找到，则直接赋值
              selectOption = {
        ...
        if (multiple) {
          ...
          // 如果是 tags 模式，单独处理
          if (defaultValue) {
            setSelectValueList(Array.isArray(defaultValue) ? defaultValue.map(item => {
  ...
  (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useEffect)(() => {
    if (!isShow) {
      ...
      const findIndex = newOptions.findIndex(item => item[valueKey] === (selectValue === null || selectValue === void 0 ? void 0 : selectValue[valueKey]));
      // 存下聚焦索引
  ...
  return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    ...
    className: "adou-select d-flex align-items-center ps-0 pe-2 ".concat(selectContentExternalCls || "", " ").concat(isFocus ? "adou-form-control-focus" : ""),
    style: {
      textAlign: "left",
      background: disabled ? "var(--bs-secondary-bg)" : transparent ? "transparent" : backgroundColor ? backgroundColor : varient === "filled" ? "#f0f0f0" : "",
      flex: 1,
      minHeight: size === "lg" ? "48px" : size === "sm" ? "33.6px" : "38px",
      // 如果 varient 是 boderless，则边框为空，否则，如果不是 formItem，则边框为 1px solid #ced4da，否则为边框为 空
      border: varient === "borderless" ? "none" : !isFormItem ? "1px solid var(--bs-border-color)" : "",
    ...
    className: "adou-select-value-list ps-2 d-flex flex-wrap align-items-center flex-fill"
  ...
  }, typeof item === "object" ? item[labelKey] : item), !disabled && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("span", {
  ...
  mode !== "liveSearch" && !showSearch && !filterOption && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "select-value-empty-placeholder flex-fill text-secondary px-2"
  ...
  }, suffix), clearable && isEnter && (multiple ? selectValueList.length : selectValue === null || selectValue === void 0 ? void 0 : selectValue[valueKey || labelKey]) ? /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "adou-select-clear-icon-box fade-enter d-flex"
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("i", {
  ...
  })) : commonSuffixContent ? /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "adou-select-common-sufiix-content text-secondary",
    style: {
      textAlign: "right",
      whiteSpace: "nowrap"
    }
  }, commonSuffixContent) : null, commonSuffixIcon ? /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("i", {
    onClick: handleClickCommonSuffixIcon,
    className: "".concat(commonSuffixIcon, " adou-select-common-suffix-icon")
  }) : null, showIcon ? /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    ...
    className: "adou-select-icon ".concat(isShow ? "rotate-up" : "rotate-down")
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("svg", {
    className: "".concat(isShow ? "rotate-up" : "rotate-down"),
    width: "10px",
    height: "10px",
    viewBox: "0 -4.5 20 20"
  ...
  }))))))) : null, mode === "common" && !showSearch && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("input", {
    type: "text",
    style: {
      width: "0px",
      height: "1px",
    ...
    className: "adou-select-option ".concat(focusedIndex === index ? "adou-select-option-active" : "", " ").concat(optionContentEllipsis ? "ellipsis-1" : ""),
    key: item[valueKey]
...
/* harmony default export */ const src_0 = (Select);
})();
