...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.adou-textarea-warpper .adou-textarea-form-content {
  display: flex;
  flex: 1;
  position: relative;
}
.adou-textarea-warpper .adou-textarea-form-content .adou-textarea-clear-icon-box {
  position: absolute;
  top: 10px;
  right: 14px;
}
.adou-textarea-warpper .adou-textarea-form-content .adou-textarea-clear-icon {
  cursor: pointer;
  transition: all 0.3s;
  color: #c6c6cd;
}
.adou-textarea-warpper .adou-textarea-form-content .adou-textarea-clear-icon:hover {
  transform: scale(1.2);
  color: red !important;
}
.adou-textarea-warpper .adou-textarea-form-content .adou-textarea-common-sufiix-content {
  position: absolute;
  bottom: 10px;
  right: 28px;
}`, "",{"version":3,"sources":["webpack://./src/index.scss"],"names":[],"mappings":"AAEI;EACI,aAAA;EACA,OAAA;EACA,kBAAA;AADR;AAGQ;EACI,kBAAA;EACA,SAAA;EACA,WAAA;AADZ;AAKQ;EACI,eAAA;EACA,oBAAA;EACA,cAAA;AAHZ;AAKY;EACI,qBAAA;EACA,qBAAA;AAHhB;AAOQ;EACI,kBAAA;EACA,YAAA;EACA,WAAA;AALZ","sourcesContent":[".adou-textarea-warpper {\r\n\r\n    .adou-textarea-form-content {\r\n        display: flex;\r\n        flex: 1;\r\n        position: relative;\r\n\r\n        .adou-textarea-clear-icon-box {\r\n            position: absolute;\r\n            top: 10px;\r\n            right: 14px;\r\n\r\n        }\r\n\r\n        .adou-textarea-clear-icon {\r\n            cursor: pointer;\r\n            transition: all 0.3s;\r\n            color: #c6c6cd;\r\n\r\n            &:hover {\r\n                transform: scale(1.2);\r\n                color: red !important;\r\n            }\r\n        }\r\n\r\n        .adou-textarea-common-sufiix-content {\r\n            position: absolute;\r\n            bottom: 10px;\r\n            right: 28px;\r\n        }\r\n    }\r\n\r\n\r\n}"],"sourceRoot":""}]);
// Exports
...
const Textarea = /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().forwardRef((props, ref) => {
  ...
  }), clearable && isEnter && value && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "adou-textarea-clear-icon-box d-flex fade-enter"
