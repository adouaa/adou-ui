...
*/`, "",{"version":3,"sources":["webpack://./src/index.scss"],"names":[],"mappings":"AAAA,gBAAgB;AAAhB;EACI,mBAAA;EACA,aAAA;EACA,eAAA;AAEJ;;AACA,qCAAA;AACA,6BAAA;AACA;;;;;CAAA","sourcesContent":[".CodeMirror {\r\n    border-radius: 10px;\r\n    height: 250px;\r\n    font-size: 12px;\r\n}\r\n\r\n/* ---------- Dark Mode ----------- */\r\n/* 如果样式需要单独适配暗黑模式效果，请使用以下方法 */\r\n/*\r\n.dark-mode,\r\n[data-bs-theme=dark] {\r\n   //...\r\n}\r\n*/\r\n\r\n.dark-mode,\r\n[data-bs-theme=dark] {\r\n    .xxx {}\r\n}"],"sourceRoot":""}]);
// Exports
...
var Form = __webpack_require__(401);
...
var update = injectStylesIntoStyleTag_default()(codemirror/* default */.A, options);
...
const CodeTextArea = props => {
  ...
  // 获取 `FormContext.Provider` 提供提供的 `value` 值
  const context = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useContext)(Form.FormContext);
  const [value, setValue] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)((_ref = defaultValue !== null && defaultValue !== void 0 ? defaultValue : context.formData[context.name]) !== null && _ref !== void 0 ? _ref : '');
...
/* harmony default export */ const src_0 = (withTranslation()(CodeTextArea));
})();
