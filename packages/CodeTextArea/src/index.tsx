...
import { FormContext, FormContextProps } from "adou-ui/Form";
...
const CodeTextArea: React.FC<CodeTextAreaProps> = (props: CodeTextAreaProps) => {
    ...
    const { styleActiveLine = true, mode = "htmlmixed", theme = "base16-light", lineNumbers = false, lineWrapping = true, disabled, defaultValue, onChangeOK, setFormItemValue } = props;
