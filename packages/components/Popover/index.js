...
.adou-popover .close-icon {
  position: absolute;
  right: 6px;
  top: 6px;
  cursor: pointer;
}
.adou-popover .hover-scale {
  transition: all 0.3s ease;
}
.adou-popover .hover-scale:hover {
  color: unset;
  transform: scale(1.2);
}
...
const Popover = /*#__PURE__*/(0,external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef)((_ref, ref) => {
  ...
  return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement(external_root_React_commonjs2_react_commonjs_react_amd_react_.Fragment, null, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
  ...
  }, children), content && isShow && /*#__PURE__*/external_root_ReactDOM_commonjs2_react_dom_commonjs_react_dom_amd_react_dom_default().createPortal( /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    ref: popoverRef,
    onClick: handleClick,
    onMouseEnter: handleMouseEnterPopover,
    className: "adou-popover ".concat(isVisible ? "show-tool-tip" : "", " adou-popover-").concat(position, " ").concat(wrapperClassname || ""),
    style: {
      position: "absolute",
    ...
    style: {
      borderColor: "".concat(borderColor, " transparent transparent transparent")
    },
    className: "adou-popover-arrow adou-popover-arrow-".concat(position)
  }), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "adou-popover-content",
    ref: contentRef
  }, content), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("i", {
    onClick: handleClosePopover,
    className: "close-icon fa-regular fa-circle-xmark hover-scale"
  })), document.body));
});
