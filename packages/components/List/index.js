...
const ListNode_ListNode = _ref => {
  ...
  return (
    ...
    external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("i", {
      ...
      className: "ms-1 py-1 item-name ".concat(node.children && node.children.length > 0 ? "has-children" : "no-children")
      ...
      className: "icon fa ".concat(node.deleteIcon || deleteIconClass || "fa-trash text-danger"),
