...
const FormItem = _ref => {
  ...
  const validateField = function (formName, value) {
    ...
    const validateValue = !isForm ? value : value || (data === null || data === void 0 ? void 0 : data[formName || name]);
  ...
  const getAbsolutePositionFn = () => {
    ...
    const position = (0,Utils.getAbsolutePosition)(adouFormRef.current, 0, 0);
