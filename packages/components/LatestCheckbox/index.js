...
const Checkbox = (_ref, ref) => {
  ...
  const clear = () => {
    setOptionsList(optionsList.map(item => {
      item.checked = false;
      return item;
    }));
  };
  ...
  return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    ...
    key: item[valueKey],
    className: "form-check ".concat(optionClassName ? optionClassName : "", " ").concat(index !== optionsList.length - 1 ? "me-2" : ""),
    style: {
      textAlign: "left",
      marginBottom: 0
    }
...
/* harmony default export */ const src_0 = (/*#__PURE__*/(0,external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef)(Checkbox));
})();
