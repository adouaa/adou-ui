...
const CollapseY = _ref => {
  ...
  const [activeKey, setActiveKey] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(activeName);
  const handleItemClick = name => {
    if (according) {
      setActiveKey(name);
    }
  };
  const enhancedChildren = react__WEBPACK_IMPORTED_MODULE_0___default().Children.map(children, child => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "cpllapse-y-wrapper"
  }, enhancedChildren);
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CollapseY);
})();
