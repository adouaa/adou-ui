...
;// CONCATENATED MODULE: ../Modal/src/index.tsx
...
const Modal = _ref => {
  ...
  }, title || "Modal title"), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("button", {
...
/* harmony default export */ const Modal_src = (withTranslation()(Modal));
;// CONCATENATED MODULE: ../NewForm/src/index.tsx
...
const AdouNewForm = /*#__PURE__*/(0,external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef)((_ref, AdouFormRef) => {
  ...
  return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "adou-new-form-wrapper flex-wrap",
    ref: formRef
  }, renderChildren());
});
/* harmony default export */ const NewForm_src = (AdouNewForm);
// EXTERNAL MODULE: ../Input/dist/cjs/index.js
var cjs = __webpack_require__(417);
...
const EventCalendar = _ref => {
   ...
   * 双击展示弹窗逻辑
   */
  const [dayInfo, setDayInfo] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)();
  const [modalShow, setModalShow] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)(false);
  ...
  const handleCofirmModal = () => {
    ...
    setAllDays(preArr => preArr.map(item => {
  ...
  const getCurrentMonthDays = () => {
    ...
    const data_ = Array.from({
      ...
      const findId = "".concat(currentYear, "-").concat(currentMonth, "-").concat(i + 1);
      const event = data.find(item => item.id === findId);
      return {
  ...
  const getShouldShowNextMonthDays = () => {
    ...
    const data_ = Array.from({
      ...
      const findId = "".concat(currentYear, "-").concat(currentMonth + 1, "-").concat(i + 1);
      const event = data.find(item => item.id === findId);
      console.log(findId);
      console.log(data);
      return {
   ...
   * 获取这个月的第一天和最后一天(date)
   */
  const [currentMonthFirstAndLastDate, setCurrentMonthFirstAndLastDate] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)({});
  // 这个月的第一天(date)
  ...
  (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useEffect)(() => {}, [finalShowData]);
  (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useEffect)(() => {
    if (date) {
      setCurrentDate(date);
    }
    if (data.length) {
      ...
      if (date) {
        ...
        var _data$;
        setCurrentDate(new Date((_data$ = data[0]) === null || _data$ === void 0 ? void 0 : _data$.id));
      }
    }
  }, [data, date]);
  (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useEffect)(() => {}, []);
  ...
  }, renderEvent ? renderEvent(dayInfo) : dayInfo.event))))))))), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
  ...
  })), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement(Modal_src, {
    show: modalShow,
    onCancel: handleCloseModal,
    onClose: handleCloseModal,
    onConfirm: handleCofirmModal
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement((external_root_React_commonjs2_react_commonjs_react_amd_react_default()).Fragment, null, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement(NewForm_src, {
    ref: formRef
  }, modalContent || /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement((cjs_default()), {
    label: "\u4E8B\u4EF6",
    name: "event"
  })))));
};
/* harmony default export */ const src_0 = (EventCalendar);
})();
