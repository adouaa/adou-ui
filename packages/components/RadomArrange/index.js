...
const RandomArrange = _ref => {
  ...
  const itemRefs = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useRef)(new Map());
  const itemListRef = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useRef)(null);
  const getElemBoundingClientRect = elem => {
  ...
  const handleShuffle = (0,Utils.useThrottle)(() => {
    if (!itemListRef.current) return;
    const oldPositions = recordPositions();
    const childrenCount = external_root_React_commonjs2_react_commonjs_react_amd_react_.Children.count(children);
    ...
    requestAnimationFrame(() => {
      itemRefs.current.forEach((elem, index) => {
        ...
        requestAnimationFrame(() => {
          elem.style.transition = "transform ".concat(animationDuration, "ms ").concat(animationTiming);
    ...
    onShuffle === null || onShuffle === void 0 || onShuffle();
  }, 300);

  // 简化后的包装子元素逻辑

  const wrappedChildren = external_root_React_commonjs2_react_commonjs_react_amd_react_.Children.map(children, (child, index) => {
    const enhancedChild = /*#__PURE__*/(0,external_root_React_commonjs2_react_commonjs_react_amd_react_.cloneElement)(child, {
      key: index,
      className: "random-arrange-item ".concat(child.props.className || "")
    });
  ...
  return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "random-arrange-wrapper ".concat(className)
  }, showButton && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement((Button_default()), {
    externalClassName: buttonClassName,
    onClickOK: handleShuffle
  }, buttonText), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    ref: itemListRef,
    className: "random-arrange-list"
  }, wrappedChildren));
};
/* harmony default export */ const src_0 = (RandomArrange);
})();
