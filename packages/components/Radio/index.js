...
const Radio = props => {
  ...
  const handleChange = item => {
    setOptionsList(preArr => {
      return preArr === null || preArr === void 0 ? void 0 : preArr.map(option => {
        return {
          ...option,
  ...
  return /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement((external_root_React_commonjs2_react_commonjs_react_amd_react_default()).Fragment, null, optionsList === null || optionsList === void 0 ? void 0 : optionsList.map(item => {
...
/* harmony default export */ const src = (withTranslation()(Radio));
})();
