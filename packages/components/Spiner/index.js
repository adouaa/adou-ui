...
.spinner-wrapper .loader {
  ...
  aspect-ratio: 1;
  border-radius: 50%;
  background: radial-gradient(farthest-side, #0b5ed7 94%, rgba(0, 0, 0, 0)) top/8px 8px no-repeat, conic-gradient(rgba(0, 0, 0, 0) 30%, #0b5ed7);
...
}`, "",{"version":3,"sources":["webpack://./src/index.scss"],"names":[],"mappings":"AAAA;EACE,OAAA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;AACF;AACE;EACE,WAAA;EACA,eAAA;EACA,kBAAA;EACA,8IACE;EAEF,uFAAA;EACA,iCAAA;AADJ;AAGI;EACE;IACE,wBAAA;EADN;AACF","sourcesContent":[".spinner-wrapper {\r\n  flex: 1;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: center;\r\n\r\n  .loader {\r\n    width: 50px;\r\n    aspect-ratio: 1;\r\n    border-radius: 50%;\r\n    background:\r\n      radial-gradient(farthest-side, #0b5ed7 94%, #0000) top/8px 8px no-repeat,\r\n      conic-gradient(#0000 30%, #0b5ed7);\r\n    -webkit-mask: radial-gradient(farthest-side, #0000 calc(100% - 8px), #000 0);\r\n    animation: l13 1s infinite linear;\r\n\r\n    @keyframes l13 {\r\n      100% {\r\n        transform: rotate(1turn)\r\n      }\r\n    }\r\n  }\r\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony default export */ const src_0 = (Spinner);
})();
