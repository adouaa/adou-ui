...
.adou-toast-container .adou-toast.adou-toast-success {
  background-color: #4caf50;
}
.adou-toast-container .adou-toast.adou-toast-error {
  background-color: #f44336;
}
.adou-toast-container .adou-toast.adou-toast-warning {
...
}`, "",{"version":3,"sources":["webpack://./src/index.scss"],"names":[],"mappings":"AAIA;EACI,kBAAA;EACA,SAAA;EACA,SAAA;EACA,8BAAA;EACA,aAAA;EACA,aAAA;EACA,sBAAA;EACA,qBAAA;AAHJ;AAKI;EACI,aAAA;EACA,kBAAA;EACA,kBAAA;EACA,YAAA;EACA,UAAA;EAEA,4BAAA;EACA,kDAAA;AAJR;AAMQ;EACI,yBAzBU;AAqBtB;AAOQ;EACI,yBA5BQ;AAuBpB;AAQQ;EACI,yBA/BU;AAyBtB;AASQ;EACI,UAAA;EAEA,wBAAA;AARZ;AAWQ;EACI,UAAA;EACA,wCAAA;AATZ","sourcesContent":["$toast-success-color: #4caf50;\r\n$toast-error-color: #f44336;\r\n$toast-warning-color: #ff9800;\r\n\r\n.adou-toast-container {\r\n    position: absolute;\r\n    top: 20px;\r\n    left: 50%; // 水平中心\r\n    transform: translate(-50%, 0%); // 将容器移动到中心\r\n    z-index: 1000;\r\n    display: flex;\r\n    flex-direction: column;\r\n    align-items: flex-end;\r\n\r\n    .adou-toast {\r\n        margin: 5px 0;\r\n        padding: 10px 15px;\r\n        border-radius: 5px;\r\n        color: white;\r\n        opacity: 0;\r\n        // 仅向下移动，不缩小 -- 配合 &.appearing的transform: translateY(0);不能删除哦\r\n        transform: translateY(-20px);\r\n        transition: transform 0.5s ease, opacity 0.5s ease;\r\n\r\n        &.adou-toast-success {\r\n            background-color: $toast-success-color;\r\n        }\r\n\r\n        &.adou-toast-error {\r\n            background-color: $toast-error-color;\r\n        }\r\n\r\n        &.adou-toast-warning {\r\n            background-color: $toast-warning-color;\r\n        }\r\n\r\n        &.appearing {\r\n            opacity: 1;\r\n            // 仅向下移动，不缩小 -- 配合 .adou-toast的transform: translateY(-20px); 不能删除哦\r\n            transform: translateY(0);\r\n        }\r\n\r\n        &.disappearing {\r\n            opacity: 0;\r\n            transform: translateY(-20px) scaleX(0.9); // 向上移动并缩小宽度\r\n        }\r\n    }\r\n}"],"sourceRoot":""}]);
// Exports
...
const ToastContext = /*#__PURE__*/(0,external_root_React_commonjs2_react_commonjs_react_amd_react_.createContext)(undefined);
...
const ToastProvider = _ref => {
  ...
  const [toasts, setToasts] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)([]);
  const open = message => {
    const newToast = {
      ...message,
      id: toastId++
    ...
    // 设置消失动画
    setTimeout(() => {
      setToasts(prev => prev.map(toast => toast.id === newToast.id ? {
        ...toast,
        disappearing: true
      } : toast));
      setTimeout(() => {
  ...
  }, toasts.map(toast => /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    key: toast.id,
...
const useToast = () => {
  const context = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useContext)(ToastContext);
  if (!context) {
