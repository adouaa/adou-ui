...
const Select = (props) => {
    ...
    return (react_2.default.createElement("div", { className: "select-wrapper", style: style },
        react_2.default.createElement("div", { "aria-disabled": disabled, ref: customSelectRef, onBlur: handleBlur, onClick: (e) => handleDivClick(e), tabIndex: 1, className: "custom-select form-control", style: {
                textAlign: "left",
        ...
        react_dom_1.default.createPortal(react_2.default.createElement("div", { style: {
            ...
            newOptions.map((item) => (react_2.default.createElement("div", { onClick: () => handleOptionClick(item), className: "option", key: item.value }, item.label)))), document.body)));
};
