...
const Select = (props) => {
    ...
    return react_2.default.createElement("div", { className: "select-wrapper", style: style },
        ...
        react_dom_1.default.createPortal(react_2.default.createElement("div", { style: { maxHeight, position: "absolute", top: (customSelectContentPosition.y + customSelectContentPosition.height) + "px", left: customSelectContentPosition.x + "px" }, ref: contentRef, className: `custom-select-content ${showOptions ? "custom-select-content-open" : ""}` }, showOptions && (newOptions.length > 0 ? newOptions.map(item => react_2.default.createElement("div", { onClick: () => handleOptionClick(item), className: "option", key: item.value }, item.label)) : react_2.default.createElement("div", { className: "none-option" }, "Nothing"))), document.body));
};
