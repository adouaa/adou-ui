...
const FormItem = (props) => {
    ...
    const renderContent = () => {
        ...
        if (react_1.default.isValidElement(children)) {
            return (react_1.default.createElement(react_1.default.Fragment, null,
                ...
                error && react_1.default.createElement("div", { className: "form-item-error text-danger small", style: { textAlign: "left", margin: `-15px 0 5px ${label.length * labelWidth + "px"}` } }, error)));
        }
        return null;
    };
    // Form自动校验逻辑
    ...
    return react_1.default.createElement(index_1.FormContext.Provider, { value: { ...context, checkValidate, name } }, renderContent());
};
