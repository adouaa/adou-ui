...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.drawer-wrapper .offcanvas {
  position: fixed;
  background-color: #fff;
  z-index: 1045;
...
.drawer-wrapper .offcanvas-start {
  top: 0;
  left: 0;
  transform: translateX(-100%);
}
.drawer-wrapper .offcanvas-end {
  top: 0;
  right: 0;
  transform: translateX(100%);
}
.drawer-wrapper .offcanvas-top {
  top: 0;
  right: 0;
  left: 0;
  transform: translateY(-100%);
}
.drawer-wrapper .offcanvas-bottom {
  right: 0;
  bottom: 0;
  left: 0;
  transform: translateY(100%);
}
.drawer-wrapper .offcanvas.show {
  transform: none;
}
.drawer-wrapper .offcanvas.hiding.drawer-start {
  transform: translateX(-100%);
}
.drawer-wrapper .offcanvas.hiding.drawer-end {
  transform: translateX(100%);
}
.drawer-wrapper .offcanvas.hiding.drawer-top {
  transform: translateY(-100%);
}
.drawer-wrapper .offcanvas.hiding.drawer-bottom {
  transform: translateY(100%);
}
...
.drawer-wrapper .drawer-backdrop.fade {
  opacity: 0;
}
.drawer-wrapper .drawer-backdrop.show {
  opacity: 1;
}
.drawer-wrapper .drawer-trigger {
  display: inline-block;
  cursor: pointer;
}`, "",{"version":3,"sources":["webpack://./src/index.scss"],"names":[],"mappings":"AACI;EACI,eAAA;EACA,sBAAA;EACA,aAAA;EACA,sCAAA;EACA,UAAA;AAAR;AAEQ;EACI,MAAA;EACA,OAAA;EACA,4BAAA;AAAZ;AAGQ;EACI,MAAA;EACA,QAAA;EACA,2BAAA;AADZ;AAIQ;EACI,MAAA;EACA,QAAA;EACA,OAAA;EACA,4BAAA;AAFZ;AAKQ;EACI,QAAA;EACA,SAAA;EACA,OAAA;EACA,2BAAA;AAHZ;AAMQ;EACI,eAAA;AAJZ;AAQY;EACI,4BAAA;AANhB;AASY;EACI,2BAAA;AAPhB;AAUY;EACI,4BAAA;AARhB;AAWY;EACI,2BAAA;AAThB;AAcI;EACI,aAAA;EACA,mBAAA;EACA,8BAAA;EACA,aAAA;EACA,gCAAA;AAZR;AAeI;EACI,aAAA;EACA,gBAAA;AAbR;AAgBI;EACI,eAAA;EACA,MAAA;EACA,OAAA;EACA,YAAA;EACA,aAAA;EACA,oCAAA;EACA,aAAA;AAdR;AAgBQ;EACI,UAAA;AAdZ;AAiBQ;EACI,UAAA;AAfZ;AAmBI;EACI,qBAAA;EACA,eAAA;AAjBR","sourcesContent":[".drawer-wrapper {\r\n    .offcanvas {\r\n        position: fixed;\r\n        background-color: #fff;\r\n        z-index: 1045;\r\n        transition: transform .3s ease-in-out;\r\n        outline: 0;\r\n\r\n        &-start {\r\n            top: 0;\r\n            left: 0;\r\n            transform: translateX(-100%);\r\n        }\r\n\r\n        &-end {\r\n            top: 0;\r\n            right: 0;\r\n            transform: translateX(100%);\r\n        }\r\n\r\n        &-top {\r\n            top: 0;\r\n            right: 0;\r\n            left: 0;\r\n            transform: translateY(-100%);\r\n        }\r\n\r\n        &-bottom {\r\n            right: 0;\r\n            bottom: 0;\r\n            left: 0;\r\n            transform: translateY(100%);\r\n        }\r\n\r\n        &.show {\r\n            transform: none;\r\n        }\r\n\r\n        &.hiding {\r\n            &.drawer-start {\r\n                transform: translateX(-100%);\r\n            }\r\n\r\n            &.drawer-end {\r\n                transform: translateX(100%);\r\n            }\r\n\r\n            &.drawer-top {\r\n                transform: translateY(-100%);\r\n            }\r\n\r\n            &.drawer-bottom {\r\n                transform: translateY(100%);\r\n            }\r\n        }\r\n    }\r\n\r\n    .drawer-header {\r\n        display: flex;\r\n        align-items: center;\r\n        justify-content: space-between;\r\n        padding: 1rem;\r\n        border-bottom: 1px solid #dee2e6;\r\n    }\r\n\r\n    .drawer-body {\r\n        padding: 1rem;\r\n        overflow-y: auto;\r\n    }\r\n\r\n    .drawer-backdrop {\r\n        position: fixed;\r\n        top: 0;\r\n        left: 0;\r\n        width: 100vw;\r\n        height: 100vh;\r\n        background-color: rgba(0, 0, 0, 0.5);\r\n        z-index: 1040;\r\n\r\n        &.fade {\r\n            opacity: 0;\r\n        }\r\n\r\n        &.show {\r\n            opacity: 1;\r\n        }\r\n    }\r\n\r\n    .drawer-trigger {\r\n        display: inline-block;\r\n        cursor: pointer;\r\n    }\r\n}"],"sourceRoot":""}]);
// Exports
...
const Drawer = /*#__PURE__*/(0,external_root_React_commonjs2_react_commonjs_react_amd_react_.forwardRef)((_ref, ref) => {
  let {
    actRef,
    clickOutside = true,
    children,
  ...
  const [hiding, setHiding] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)(false);
  const [show, setShow] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)(false);
  const [showMaskState, setShowMaskState] = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useState)(false);
  const offCanvasRef = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useRef)(null);
  ...
  (0,Utils.useClickOutside)([offCanvasRef], handleClose, clickOutside && offCanvasRef.current && show);
  (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useImperativeHandle)(actRef || ref, () => ({
    open: handleOpen,
    close: handleClose,
  ...
  }, trigger && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    onClick: toggleOffcanvas,
    className: "drawer-trigger"
  }, trigger), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    ref: offCanvasRef,
    className: "offcanvas offcanvas-".concat(placement, " drawer-").concat(placement, " ").concat(show ? "show" : "", " ").concat(hiding ? "hiding" : "", " ").concat(className),
    style: getPlacementStyles(),
    tabIndex: -1,
    role: "dialog",
    "aria-modal": "true"
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "offcanvas-header ".concat(headerClassName)
  }, /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("h5", {
    className: "offcanvas-title"
  }, title), showCloseButton && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("button", {
    onClick: handleClose,
    type: "button",
    className: "btn-close",
    "aria-label": "Close"
  })), /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    className: "offcanvas-body ".concat(bodyClassName)
  }, children)), showMask && showMaskState && /*#__PURE__*/external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", {
    onClick: handleMaskClick,
    style: {
      transition: "all .3s ease"
    },
    className: "offcanvas-backdrop fade ".concat(show ? "show" : "")
  }));
});
Drawer.displayName = "Drawer";
/* harmony default export */ const src_0 = (Drawer);
})();
