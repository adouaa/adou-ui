...
const App = () => {
    ...
    const handleToggle = (nodeId) => {
        ...
        setTreeData((prevData) => prevData.map((node) => (node.id === nodeId ? { ...node, isExpanded: !node.isExpanded } : node)));
    };
    ...
    return (
        <div>
            ...
            {/* <Collapse></Collapse> */}
            <Button onClickOK={handleShowCollapse} externalClassName="btn btn-primary" type="warning">
                ...
                <div className="row">
                    <ResizableSidebar>
                        ...
                        <List
                            ...
                            isTree={true}
                            onToggleIconClick={handleIconClick}
