...
const HorizonScrollView = memo(({ children }) => {
    ...
    return (
        <div className="horizon-scroll-view-wrapper">
            {showLeftBtn && (
                <div className="horizon-scroll-view-btn left hover-scale" onClick={() => handleScrollBtnClick(false)}>
                    <IconArrowLeft />
                </div>
            )}
            {showRightBtn && (
                <div className="horizon-scroll-view-btn right hover-scale" onClick={() => handleScrollBtnClick(true)}>
                    <IconArrowRight />
                </div>
            )}
