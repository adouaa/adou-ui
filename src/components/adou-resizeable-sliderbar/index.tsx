...
const ResizableSidebar = ({
    ...
    const [isShowToggleBtnWhenNotExpanded, setIsShowToggleBtnWhenNotExpanded] = useState<boolean>(showTggleBtnWhenNotExpanded);
        ...
        <>
            ...
            >
                ...
                : {}), */
                        ...
                        >
                            <i className={`fa-solid text-white ${parseFloat(currentSidebarWidth) <= minWidth ? 'fa-angles-right' : 'fa-angles-left'}`}></i>
                        </div>
                    ) : (
                        ''
                    )
