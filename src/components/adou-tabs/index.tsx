                ...
                {tabStyle === 'common' ? (
                    <div className="header-wrapper">
                        <div className="tabs-header mb-2  d-flex align-items-center">
                                    ...
                                    return (
                                        <div key={index}>
                                            <div className={`tabs-header-item-box ${index === 0 && 'first'}`}>
                                                ...
                                                >
                                                    <div className={`label-icon me-1`}>{child?.props?.headerIcon}</div>
                            ...
                            {commonExtraContent && <div className="common-extra-content">{commonExtraContent}</div>}
                            {content.current && <div className="extra-content">{content.current}</div>}
                        </div>
                    </div>
                ) : (
                    <div className="header-wrapper">
