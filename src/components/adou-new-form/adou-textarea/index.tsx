...
const TextArea: React.FC<TextAreaProps> = React.forwardRef((props: TextAreaProps, ref) => {
    ...
    const { errMsg, labelWidth, labelColor, commonSuffixIcon, readOnly, externalClassName, width, inputGroup = false, labelPosition = "center", required = false, name, label, placeholder, disabled, defaultValue, onChangeOK } = props;
