...
const Popover: React.FC<PopoverProps> = forwardRef(({ show = true, content, position = 'top', children, bgc, color, borderColor, wrapperClassname, onClose }, ref) => {
    ...
    useClickOutside([popoverRef], handleClosePopover, isVisible && isShow && Boolean(popoverRef.current));
        ...
        <div className={`adou-popover-wrapper ${wrapperClassname || ''}`}>
            ...
            {content && isShow && (
                <div
                    ...
                    className={`adou-popover ${isVisible ? 'show-tool-tip' : ''} adou-popover-${position}`}
