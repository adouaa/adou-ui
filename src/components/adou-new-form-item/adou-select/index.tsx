...
export interface SelectProps {
  ...
  const Select = React.forwardRef((props: SelectProps, ref) => {
    ...
    const getValue = () => {
      ...
      if (
        ...
        if (returnType === "obj") {
          ...
          handleFieldChange &&
            handleFieldChange(value[valueKey] || value[labelKey]);
        }
    ...
    const getMaxSelectValueWidth = () => {
      const selectWidth = getContentWidth(customSelectRef.current);
      ...
      >
        ...
        <div className="adou-select-form-content">
          <div
            ...
            className={`adou-select d-flex align-items-center form-control ${
              selectContentExternalCls || ""
            }`}
            style={{
              textAlign: "left",
          ...
          >
            ...
            value?.[valueKey] === false ? (
              ...
              <span
                className="adou-select-placeholder text-secondary"
                style={{ flex: 1 }}
              >
                {placeholder}
              </span>
