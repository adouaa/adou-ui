...
const App = () => {
    ...
    const [defaultCheckboxValue, setDefaultCheckboxValue] = useState<any[]>(['Shùxué', 'Shēngwù']);

    const [retrieveSelectDefaultValue, setretrieveSelectDefaultValue] = useState<any[]>([{ value: 'Wú Yìfán' }, { value: 'Zhāng zhizhi' }]);
    ...
    return (
        <div>
            <Button type="primary" onClickOK={handleGetFormData}>
                收集
            </Button>
            <Button type="danger" onClickOK={handleClearForm}>
                清除
            </Button>
            <Button type="warning" onClickOK={handleValidateForm}>
                校验
            </Button>
            ...
            <AdouNewForm data={{}} ref={adouNewFormRef}>
                ...
                <AdouSelect
                    defaultValue={'Běijīng zhájiàng miàn'}
                    commonSuffixIcon="fa-solid fa-circle-xmark text-danger"
                    externalClassName="mb-2"
                    labelPosition="center"
                    label="测试"
                ...
                <AdouRetrieveSelect
                    ...
                    defaultValue={retrieveSelectDefaultValue}
                    name="test-retrieve-select"
                    options={options}
                ></AdouRetrieveSelect>
                <AdouTagInput
                    defaultValue={tagInputDefaultValue}
                    commonSuffixIcon="fa-solid fa-circle-xmark text-danger"
                    labelPosition="left-top"
                    label="测试"
                    name="test-tag-input"
