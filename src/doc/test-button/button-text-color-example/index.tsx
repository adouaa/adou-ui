        ...
        <div className="button-text-color-example mt-2">
            <Card>
                ...
                <div className="plain-btn mt-4">
                    <Button textColor="primary" externalClassName="me-2" outlineColor="warning">
                        warning
                    </Button>
                    <Button textColor="secondary" externalClassName="me-2" outlineColor="info">
                        info
                    </Button>
                    <Button textColor="success" externalClassName="me-2" outlineColor="light">
                        light
                    </Button>
                    <Button textColor="danger" externalClassName="me-2" outlineColor="dark">
                        dark
                    </Button>
                </div>
            </Card>
