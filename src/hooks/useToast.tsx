...
const ToastContainer = () => {
    ...
    const handleMouseLeave = (id: number) => {
        ...
        const timer = setTimeout(() => {
            toasts = toasts.map((t) => (t.id === id ? { ...t, disappearing: true } : t));
            setToastList([...toasts]);
    ...
    const handleClose = (toast: ToastProps) => {
        ...
        toasts = toasts.map((t) => (t.id === toast.id ? { ...t, disappearing: true } : t));
        setToastList([...toasts]);
            ...
            {toastList.map((toast) => (
                ...
                >
                    <div className="adou-toast-content">
                        {toast.content}
                        <button className="adou-toast-close" onClick={() => handleClose(toast)}>
                            &times;
                        </button>
                    </div>
                    <div
