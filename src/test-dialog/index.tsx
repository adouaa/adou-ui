...
const Dialog: React.FC<DialogProps> = ({
    ...
    const { position, handleMouseDown } = useDrag(triggerRef, dialogRef, draggble && !max, false);
                        ...
                        {!destroied && (
                            ...
                            >
                                ...
                                <div className="dialog-footer d-flex justify-content-end p-3">
                                    ...
                                    {showConfirm && (
                                        <Button loading={confirmBtnLoading} disabled={!canConfirm} externalClassName={`btn-${confirmBtnClass}`} size="md" onClickOK={onConfirm}>
                                            {confirmText}
                                        </Button>
                                    )}
                                </div>
